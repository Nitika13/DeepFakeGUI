...
public class DeepfakeDetectorGUI extends JFrame {
    ...
    public DeepfakeDetectorGUI() {
        ...
        topPanel.setBackground(Color.BLACK); // Black background
        ...
        titleLabel.setForeground(new Color(138, 43, 226)); // Violet
        ...
        searchField.setBackground(new Color(30, 30, 30)); // Dark gray background
        searchField.setForeground(Color.WHITE); // White text
        searchField.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(138, 43, 226), 1), // Violet border
        ...
        centerPanel.setBackground(Color.BLACK); // Black background
        ...
        styleButton(detectButton, new Color(138, 43, 226)); // Violet button
        ...
        progressBar.setForeground(new Color(138, 43, 226)); // Violet progress bar
        progressBar.setBackground(new Color(30, 30, 30)); // Dark gray background
        centerPanel.add(progressBar, gbc);

        // Footer Panel
        JPanel footerPanel = new JPanel();
        footerPanel.setLayout(new BoxLayout(footerPanel, BoxLayout.Y_AXIS));
        footerPanel.setBackground(Color.BLACK); // Black background
